...
public class Const {
    ...
    public static final String DATABASE_NAME = "pathone_location_tracking.sqlite"; //Change it
    public static final String DATABASE_PATH = "/data/data/one.path.pathonetracking/databases/"; //Change it
